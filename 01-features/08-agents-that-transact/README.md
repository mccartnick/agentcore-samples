...
|--------|---------------|
| [`00-getting-started/`](00-getting-started/) | Nine step-by-step tutorials covering setup → local agents → runtime deploy → wallet ops → gateway → browser payments → memory + payments → multi-agent orchestration |
...
- **OpenAI Agents SDK with one payment-enabled specialist** → `00-getting-started/08-openai-paid-research-agent/`
